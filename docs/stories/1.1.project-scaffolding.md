...
- [ ] **Task 1: Create Python Virtual Environment** (AC: 1)
  - [ ] Create virtual environment using `python -m venv venv`
  - [ ] Document activation commands for different platforms in README
  - [ ] Verify Python version is 3.9+

- [ ] **Task 2: Create Complete Directory Structure** (AC: 2)
  - [ ] Create root-level files (.gitignore, README.md, LICENSE, pyproject.toml)
  - [ ] Create `contreact_ollama/` package with all subpackages (core/, state/, llm/, tools/, diversity/, logging/)
  - [ ] Create `ui/` directory with pages/ subdirectory
  - [ ] Create `scripts/` directory
  - [ ] Create `tests/` directory with subdirectories (unit/, integration/, fixtures/)
  - [ ] Create `configs/` directory with .gitkeep and sample-config.yaml
  - [ ] Create `data/` directory with .gitkeep
  - [ ] Create `logs/` directory with .gitkeep
  - [ ] Create `docs/` directory (if not already existing)
  - [ ] Add `__init__.py` files to all Python packages

- [ ] **Task 3: Create .gitignore File** (AC: 3)
  - [ ] Add Python-specific exclusions (*.pyc, __pycache__, .pytest_cache, venv/, .venv/)
  - [ ] Add project-specific exclusions (configs/*.yaml except sample, data/*, logs/*.jsonl)
  - [ ] Add IDE-specific exclusions (.vscode/, .idea/, *.swp)
  - [ ] Keep .gitkeep files tracked in otherwise empty directories

- [ ] **Task 4: Create Dependency Configuration** (AC: 4)
  - [ ] Create `pyproject.toml` with project metadata and dependencies
  - [ ] List all dependencies with minimum versions from tech stack
  - [ ] Include development dependencies (pytest, black, isort, mypy)
  - [ ] Set Python version requirement to >=3.9

- [ ] **Task 5: Install Dependencies** (AC: 5)
...
- [ ] **Task 6: Create README.md** (AC: 6)
  ...
  - [ ] Add basic usage information (placeholder for run_experiment.py)
  - [ ] Add project structure overview
  - [ ] Add license information

- [ ] **Task 7: Initialize Git Repository** (AC: 7)
  - [ ] Run `git init` if not already initialized
  - [ ] Stage all scaffolding files (git add)
  - [ ] Create initial commit with message "Initial project scaffolding"
  - [ ] Verify .gitignore is working (no data/, logs/, configs/*.yaml in staging)
