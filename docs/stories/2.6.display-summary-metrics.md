...
- [ ] **Task 1: Extract Summary Metrics from DataFrame** (AC: 1, 2)
  - [ ] Filter DataFrame for CYCLE_END events
  - [ ] Extract metrics from payload field
  - [ ] Aggregate metrics across all cycles
  - [ ] Calculate summary statistics

- [ ] **Task 2: Display Key Metrics with st.metric** (AC: 1)
  - [ ] Create metrics layout with st.columns
  - [ ] Display total memory operations
  - [ ] Display total messages to operator
  - [ ] Display total response characters
  - [ ] Display total memory write characters

- [ ] **Task 3: Display Full Metrics Table** (AC: 2)
  - [ ] Create DataFrame of all metrics
  - [ ] Format for display
  - [ ] Show using st.dataframe
  - [ ] Enable sorting/filtering

- [ ] **Task 4: Check for PEI Assessment** (AC: 3)
  - [ ] Look for PEI assessment file
  - [ ] Load PEI results if exists
  - [ ] Parse PEI data
  - [ ] Display in table format

- [ ] **Task 5: Error Handling** (AC: 1, 2, 3)
...
- [ ] **Task 6: Testing** (AC: 1, 2, 3)
  ...
  - [ ] Test full table shows all data
  - [ ] Test PEI assessment display
